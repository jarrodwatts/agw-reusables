...
- `/config`
  - [`abstract-contracts.ts`](#abstract-contractsts) - Contract addresses, ABIs, and configuration
- `/lib`
  - [`chain-utils.ts`](#chain-utilsts) - Network-aware utility functions for address resolution
- `/types`
  - [`contracts.ts`](#typescontractsts) - Contract addresses, ABIs, and configuration
...
<ComponentSource src="registry/new-york/blocks/abstract-contracts/lib/abstract-contracts.ts" />
...
<ComponentSource src="registry/new-york/blocks/abstract-contracts/lib/chain-utils.ts" />
...
<ComponentSource src="types/contracts.ts" />
