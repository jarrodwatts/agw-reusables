...
<Steps className="mt-8">
  ...
  <Step step={2} title="Generate a secure password">
  ...
  <Step step={3} title="Add environment variable">
...
- `/types`
  - [`siwe-auth.ts`](#typests) - TypeScript type definitions
...
<ComponentSource src="/types/siwe-auth.ts" />
